...
class AllTest {
    ...
    fun test01() {
        ...
        createKeyList.add(Jwt.HS256.toJwtKeyByBase64Url(encodeBase64UrlString("HS256_4_key")))
        ...
        createKeyList.add(Jwt.HS384.toJwtKeyByBase64Url(encodeBase64UrlString("HS384_4_key")))
        ...
        createKeyList.add(Jwt.HS512.toJwtKeyByBase64Url(encodeBase64UrlString("HS512_4_key")))
    ...
    fun test02() {
        ...
        createKeyList.forEach(Consumer { key: JwtKey -> stringKeyList.add(key.stringify) })
