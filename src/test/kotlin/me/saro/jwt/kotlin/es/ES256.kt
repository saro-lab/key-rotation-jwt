...
class ES256 {
    ...
    fun t1() {
        ...
        val publicKey = "MFkwEwYHKoZIzj0CAQYIKoZIzj0DAQcDQgAEEVs/o5+uQbTjL3chynL4wXgUg2R9" +
                "q9UU8I5mEovUf86QZ7kOBIjJwqnzD1omageEHWwHdBO6B+dFabmdT9POxg=="
        val privateKey = "MIGHAgEAMBMGByqGSM49AgEGCCqGSM49AwEHBG0wawIBAQQgevZzL1gdAFr88hb2" +
    ...
    fun t3() {
        ...
        wrongKeyStore["1"] = JwtHs256().randomJwtKey()
        for (i in jwtList.indices) {
            val jwtObject =
